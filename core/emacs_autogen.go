...
func (ec *execContext) symbolsOfEmacs_autogen() {
	...
	ec.defSubr7(nil, "x-change-window-property", ec.xChangeWindowProperty_autogen, 2)
	ec.defSubr6(nil, "x-change-window-property", ec.xChangeWindowProperty_1_autogen, 2)
	ec.defSubr3(nil, "x-delete-window-property", ec.xDeleteWindowProperty_autogen, 1)
	ec.defSubr2(nil, "x-delete-window-property", ec.xDeleteWindowProperty_1_autogen, 1)
